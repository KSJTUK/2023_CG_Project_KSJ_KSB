...
// TODO
constexpr glm::vec3 RAY_DIRECTION = glm::vec3{ 0.f,0.f,1.f };
constexpr glm::vec3 RAY_ORIGIN = glm::vec3{ 0.f };
...
bool Animated::Zombie::nRayCasting() {
	...
	if (m_model->RayCasting(RAY_ORIGIN, RAY_DIRECTION, WorldMatrix)) {
		return true;
	}
